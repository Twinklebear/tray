...
Colorf PathIntegrator::trace_camera(const Scene &scene, const Renderer&, const RayDifferential &r,
...
Colorf PathIntegrator::trace_light(const Scene &scene, const Renderer&, Sampler &sampler,
